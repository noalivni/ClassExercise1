...
public class Main {
    public static void main(String[] args) {
        ...
        customerList.add(new SilverCustomer(2, "cust2"));
        customerList.add(new GoldCustomer(3, "cust3"));
        customerList.add(new StandardCustomer(4, "cust4"));
        customerList.add(new SilverCustomer(5, "cust5"));
        customerList.add(new GoldCustomer(6, "cust6"));
        customerList.add(new StandardCustomer(7, "cust7"));
        customerList.add(new SilverCustomer(8, "cust8"));
